...
public class RestClientFarmFacadeTest {
    ...
    public void testGetAnimalsOfType() {
        LOG.debug("start of testGetAnimalsofType()");
        String msg = "returned :";
        List<Animal> animals = farmFacade.getAnimalsOfType(msg);
        for (Animal value : animals) {
            msg = msg + value + ",";
        }
        LOG.debug(msg);
    ...
    public void testGetAnimal() {
        LOG.debug("start of testGetAnimal()");
        
        Animal animal = farmFacade.getAnimal("Jeff");

        LOG.debug("found animal:"+animal);
    ...
    public void testRemoveAnimal() {
        ...
        String name = "randomName_" + new Date().getTime();
        boolean animal = farmFacade.removeAnimal(name);
        String msg = "removed :" + animal;
        LOG.debug(msg);
